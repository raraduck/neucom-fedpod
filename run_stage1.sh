...
#
# Usage:
#   bash run_stage1.sh [-E epochs] [-g gpu]
...
# 9 major institutions (≥20 train cases each; covers 935/1134 = 82% of data)
INSTS=(1 2 3 10 22 24 25 26 28)
...
bash run_aggregation.sh -j "$JOB_LIST" -A "$AGG" -R "$ROUNDS" -r 0 -a fedavg
